...
function PintarPosicion(posicion: {lat:number, long:number}){
...
function muestra3(nombre: string = 'Alfonso'){
    console.log(nombre);
}
...
let valorDevuelto = function(nombre: string){
    return nombre.toUpperCase();
}
//Esto mismo en una funcion de felcha seria: 
const valorDevuelto2 = (nombre: string) => nombre.toUpperCase();
